...
public class PriorityModule extends Module {
    static class PriorityRequest extends AbstractRequest {
        ...
        @Override public String displaySummary() {
            return String.format("PR ID:%d | %s | Location:%s | Level:%s | Prio:%d",
    ...
    void add() {
        ...
        String type = readNonEmpty("Level of Urgency(1-Critcal, 2- Non-Critical): ");
        System.out.print("Priority (1- Highest, 2-Lowest): ");
